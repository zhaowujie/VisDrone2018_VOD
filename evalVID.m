...
datasetPath = '/media/hp208/4t/zhaoxingjie/graduation_project/VisDrone/VisDrone2018-VID-val/'; % dataset path
resPath = '/media/hp208/4t/zhaoxingjie/graduation_project/VisDrone/results/ssd_fish_se_contrast_mul_task/'; % result path
% resPath = '/media/hp208/4t/zhaoxingjie/graduation_project/VisDrone/results/sniper/final/'; % result path

gtPath = fullfile(datasetPath, 'annotations', 'default'); % annotation path
